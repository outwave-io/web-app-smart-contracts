...
contract('EventPurchaseHook', () => {
  describe('purchase NFT with native tokens / behavior ', () => {
    ...
    it('lock should have balance', async () => {
      ...
      assert.isBelow(
        parseInt(await web3.eth.getBalance(publiclock.address)),
        parseInt(keyPrice)
      )
    })
  ...
  describe('purchase NFT with ERC20 tokens / behavior ', () => {
    ...
    it('should dao user have 0 ERC20 Balance', async () => {
    ...
    it('lock should have balance', async () => {
      ...
      assert.isBelow(
        parseInt(await tokenDai.balanceOf(publiclock.address)),
        parseInt(keyPrice)
      )
    })
    it('dao should have balance', async () => {
      ...
      assert.isBelow(
        parseInt(await tokenDai.balanceOf(daoUser.address)),
        parseInt(keyPrice)
      )
    })
    it('should user have valid keys', async () => {
